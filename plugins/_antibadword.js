...
“Whoever believes in God and the Last Day, let him say good or be silent” (HR. al-Bukhari dan Muslim).`, '© Naruto By Rafi Ser', 'Turn on Antibadword', ',1 antibadword', 'Astaghfirullah', ',maaf', m)
        if (user.warning >= 5) {
            user.banned = true
            if (m.isGroup) {
                if (isBotAdmin) {
